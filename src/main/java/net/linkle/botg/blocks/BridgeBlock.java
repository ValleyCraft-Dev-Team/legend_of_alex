...
public class BridgeBlock extends HorizontalWithWaterBlock {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        if (context instanceof EntityShapeContext entityContext && entityContext.getEntity() instanceof LivingEntity entity) {
            Predicate<ItemStack> predicate = stack -> {
                return stack.getItem() instanceof BlockItem blockItem && blockItem.getBlock() instanceof BridgeBlock;
            };
